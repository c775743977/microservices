...
func (c *cartServiceClient) CreateCart(ctx context.Context, in *CartReqByUserID, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type CartServiceServer interface {
	...
	CreateCart(context.Context, *CartReqByUserID) (*Result, error)
...
func (UnimplementedCartServiceServer) CreateCart(context.Context, *CartReqByUserID) (*Result, error) {
...
func _CartService_CreateCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).CreateCart(ctx, req.(*CartReqByUserID))
	}
	return interceptor(ctx, in, info, handler)
}
