...
func (x *GreetRequest) GetReq() string {
	if x != nil {
		return x.Req
	}
	return ""
...
var file_greet_proto_rawDesc = []byte{
	,
...
var file_greet_proto_goTypes = []interface{}{
	(*GreetRequest)(nil),  // 0: pbfile.GreetRequest
	(*GreetResponse)(nil), // 1: pbfile.GreetResponse
}
var file_greet_proto_depIdxs = []int32{
	0, // 0: pbfile.Greet.Morning:input_type -> pbfile.GreetRequest
	0, // 1: pbfile.Greet.Night:input_type -> pbfile.GreetRequest
	1, // 2: pbfile.Greet.Morning:output_type -> pbfile.GreetResponse
	1, // 3: pbfile.Greet.Night:output_type -> pbfile.GreetResponse
...
func (c *greetClient) Morning(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pbfile.Greet/Morning", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetClient) Night(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/pbfile.Greet/Night", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greet_Morning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbfile.Greet/Morning",
	}
